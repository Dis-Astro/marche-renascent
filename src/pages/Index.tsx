      ...
      <header className="relative bg-background pt-16 pb-24 overflow-hidden" id="hero">
        <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row items-center gap-12">
          ...
          <div className="flex-1 text-center md:text-left">
            ...
            {/* Badges */}
            <div className="flex items-center gap-3 mt-6 justify-center md:justify-start"></div>
          </div>
      ...
      <section className="bg-muted py-20" id="servizi">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-14">
            <span className="text-[11px] font-bold tracking-[0.25em] uppercase text-primary block mb-2">​</span>
            <h2
